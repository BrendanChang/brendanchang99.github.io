...
The data was collected on Kaggle for case study purpose, updated version of the original data sources by the maintainer *Kaggler* Möbius. Dataset date range from 4.12.2016 to 5.12.2016. 
...
### Conclusions:
 * **Causation implied.**
 * **Total minutes asleep negatively affects sedentary behavior, On average, for 1 minutes increase in total minutes asleep, the minutes spent on sedentary behavior will decrease by 0.84 minutes**
